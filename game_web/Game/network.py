try:
    ...
    print("[Network] 'requests' not found. Offline mode forced.")
    requests = None
...
try:
    ...
    print("[Network] 'profanity' not found. Filter disabled.")
...
class LeaderboardClient:
    ...
    def __init__(self):
        ...
        self.access_token = None
        self.refresh_token = None # Store refresh token
        # Force offline on Web due to blocking requests
        if sys.platform == "emscripten":
            print("[Network] Web platform detected. Forcing Offline Mode to prevent freezing.")
            self.session = None 
            self.user = None
    ...
    def init_client(self):
        # Force offline for Web Build (requests not supported in WASM)
        self.is_offline = True
        print("[Network] Web Build: Offline Mode Enforced.")
        return
